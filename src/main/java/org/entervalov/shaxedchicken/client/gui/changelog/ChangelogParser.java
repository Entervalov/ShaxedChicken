...
/**
 * Changelog parser with Saints Row IV color palette.
 * Muted tones with purple accents.
 */
public class ChangelogParser {

    private static final Pattern BOLD_PATTERN = Pattern.compile("\\*\\*(.*?)\\*\\*");

    // Saints Row IV palette — более приглушённые тона с фиолетовым акцентом
    ...
    // Цвета категорий в SR4 стиле
    private static final int CAT_NEW = 0x9B4FDE;      // Фиолетовый — фирменный SR4
    private static final int CAT_FIX = 0x6EAADD;      // Приглушённый голубой
    private static final int CAT_SYS = 0xDD9944;      // Оранжевый
    private static final int CAT_DEF = 0xCC6699;      // Розоватый
    private static final int CAT_SOON = 0x777777;      // Серый
    private static final int CAT_DEFAULT = 0xBBBBBB;   // Светло-серый
