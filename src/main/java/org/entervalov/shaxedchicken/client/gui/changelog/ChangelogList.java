...
/**
 * Saints Row IV style scrollable changelog list.
 * Purple scrollbar, dark background, subtle fade edges.
 */
public class ChangelogList extends ExtendedList<ChangelogEntry> {
    ...
    private void renderScrollbar(MatrixStack ms) {
        ...
        int scrollbarWidth = 2; // Тоньше, чем раньше — SR4 стиль

        // Трек скроллбара — едва видимый
        ...
        if (maxScroll > 0) {
            ...
            // Ползунок — фиолетовый, без градиента (SR4 flat design)
