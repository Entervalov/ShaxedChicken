...
public class ModSpawnEvents {
    ...
    public static void onBiomeLoading(BiomeLoadingEvent event) {
        ...
        // Add structures to all overworld biomes
    ...
    /**
     * Critical: patch per-world DimensionStructuresSettings so that structures
     * appear in worlds that were created before the mod was installed, or in worlds
     * whose settings don't include the mod's structures in their saved noise settings.
     */
    ...
    public static void onWorldLoad(WorldEvent.Load event) {
        if (event.getWorld() instanceof net.minecraft.world.server.ServerWorld) {
            ...
            // Use reflection to set the structureConfig field since it's immutable
            try {
                // field_236193_d_ is the SRG name for structureConfig() return backing field
